...
![Lantern dashboard with rack spotlight and service status](docs/images/v1-dashboard-dark.png)

### Rack map

![Lantern rack map with rack-mounted device faceplates](docs/images/v1-rack-map-dark.png)

### Topology

![Lantern topology visualisation](docs/images/v1-topology-dark.png)
