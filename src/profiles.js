export const DEVICE_PROFILES = [
  ...
  { id: 'unifi-switch-48', label: 'Ubiquiti UniFi 48-port switch', brand: 'Ubiquiti', asset: 'rack-unifi-switch-48.png', height: 1, rackMount: true, passive: false },
  { id: 'unifi-udm-pro', label: 'Ubiquiti UniFi Dream Machine Pro', brand: 'Ubiquiti', asset: 'rack-unifi-udm-pro.png', height: 1, rackMount: true, passive: false },
  { id: 'unifi-uxg-pro', label: 'Ubiquiti UniFi UXG Pro gateway', brand: 'Ubiquiti', asset: 'rack-unifi-uxg-pro.png', height: 1, rackMount: true, passive: false },
